...
export default function DashboardLeadsPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // Agent/Seller scoped leads (adjust column name if needed)
    ...
    <main className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-6xl p-6">
        ...
        <div className="mt-4 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
          {filtered.length === 0 ? (
            <div className="p-5 text-sm text-slate-600">No leads assigned yet.</div>
          ) : (
        ...
        {/* Optional: link to master lead page */}
        <div className="mt-6">
          <Link
            href="/leads"
